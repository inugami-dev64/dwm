...
static const char *fonts[]          = {"W95FA:size=13:antialias=true" };
static const char dmenufont[]       = "W95FA:size=13:antialias=true";
...
static const char *termcmd[]            = { "tabbed", "-d", "st", "-w", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,           	XK_i,	            spawn,	            {.v = surf } },
